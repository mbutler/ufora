...
function createStatBlock(commoner) {
    ...
    doc.font('./fonts/noto-sans-bold.ttf')
        ...
        .font('./fonts/noto-sans-regular.ttf')
        .text(commoner.strength + '(' + _.toString(Math.floor((commoner.constitution - 10) / 2)) + ')  ', { continued: true })
        .font('./fonts/noto-sans-bold.ttf')
        .text('DEX: ', { continued: true })
        .font('./fonts/noto-sans-regular.ttf')
        .text(commoner.dexterity + '(' + _.toString(Math.floor((commoner.dexterity - 10) / 2)) + ')  ', { continued: true })
        .font('./fonts/noto-sans-bold.ttf')
        .text('CON: ', { continued: true })
        .font('./fonts/noto-sans-regular.ttf')
        .text(commoner.constitution + '(' + _.toString(Math.floor((commoner.constitution - 10) / 2)) + ')  ', { continued: true })
        .font('./fonts/noto-sans-bold.ttf')
        .text('INT: ', { continued: true })
        .font('./fonts/noto-sans-regular.ttf')
        .text(commoner.intelligence + '(' + _.toString(Math.floor((commoner.intelligence - 10) / 2)) + ')  ', { continued: true })
        .font('./fonts/noto-sans-bold.ttf')
        .text('WIS: ', { continued: true })
        .font('./fonts/noto-sans-regular.ttf')
        .text(commoner.wisdom + '(' + _.toString(Math.floor((commoner.wisdom - 10) / 2)) + ')  ', { continued: true })
        .font('./fonts/noto-sans-bold.ttf')
        .text('CHA: ', { continued: true })
        .font('./fonts/noto-sans-regular.ttf')
        .text(commoner.charisma + '(' + _.toString(Math.floor((commoner.charisma - 10) / 2)) + ')  ')
        .font('./fonts/noto-sans-bold.ttf')
